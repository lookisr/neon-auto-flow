  ...
  return (
    <section className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="relative bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-lg border border-gray-700 rounded-2xl overflow-hidden group hover:border-neon-orange/50 transition-all duration-500">
          <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="mt-4">
                <h3 className="text-xl font-bold text-white mb-2">Видео скоро появится</h3>
                <p className="text-gray-400">Мы готовим для вас интересный контент</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-lg border border-gray-700 rounded-xl p-6">
          ...
          <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-lg border border-gray-700 rounded-xl p-6">
            ...
            <p className="text-gray-300">Среднее время сделки</p>
          </div>
        </div>
      </div>
    </section>
