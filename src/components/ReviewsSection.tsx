...
const reviews = [
  ...
  },
  {
    ...
    name: "Александр Шагалин",
    text: "Очень приятный сервис, всё объяснили, деньги получил сразу. Рекомендую!"
  },
  {
  ...
  },
  {
    ...
    name: "Сергей Халилов",
    text: "Продал авто за 30 минут! Спасибо менеджеру за помощь и поддержку."
  },
  {
  ...
  },
  {
    ...
    name: "Максим Никитин",
    text: "Очень доволен, что обратился именно сюда. Деньги получил сразу после сделки."
  },
  {
